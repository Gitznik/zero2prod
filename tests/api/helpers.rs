...
impl TestApp {
    ...
    pub async fn post_subscriptions(&self, body: String) -> reqwest::Response {
        self.api_client
            .post(self.address.join("subscriptions").unwrap())
    ...
    {
        self.api_client
            .post(self.address.join("login").unwrap())
            .form(body)
            .send()
            .await
            .expect("Failed to execute request.")
    ...
    pub async fn get_login_html(&self) -> String {
        self.api_client
            .get(self.address.join("/login").unwrap())
            .send()
            .await
            .expect("Failed to execute request")
            .text()
    ...
    pub async fn get_admin_dashboard(&self) -> reqwest::Response {
        self.api_client
            .get(self.address.join("/admin/dashboard").unwrap())
            .send()
            .await
            .expect("Failed to execute request")
    }
    ...
    pub async fn get_change_password(&self) -> reqwest::Response {
        self.api_client
            .get(self.address.join("/admin/password").unwrap())
            .send()
            .await
            .expect("Failed to execute request")
    }
    ...
    {
        self.api_client
            .post(self.address.join("/admin/password").unwrap())
            .form(body)
            .send()
            .await
            .expect("Failed to execute request")
...
pub async fn spawn_app() -> TestApp {
    ...
    let address = Url::parse(&format!("http://127.0.0.1:{}", application.port())).unwrap();
